...
st.markdown("""
    ...
    .stApp {
        ...
        /* High-quality dark logistics background */
    ...
    /* This wraps the logo in a white box so it looks professional */
    .logo-box {
    ...
    /* Forces inputs to be White with Black text */
...
with st.sidebar:
    ...
    # This solves the issue of the logo looking "stuck on"
...
if menu == "Dashboard":
    ...
    # ASSESSMENT FORM
    # We use a container to group the white inputs visually
    with st.container():
    ...
    if st.button("RUN COMPLIANCE ENGINE"):
        with st.spinner("Analyzing national network constraints..."):
            # SIMULATED LOGIC
            import time
            time.sleep(1) # Fake processing delay for "feel"
